...
/**
 *
 * 특정 사용자 + 친/반친환경에 따른 지출 내역과 총합 가져오기
...
public class JobConfiguration3 {
    ...
    private final DataSource dataSource; // Jdbc에 필요함
    private final EntityManagerFactory entityManagerFactory; // Jpa에 필요함
    ...
    public ItemReader<? extends Expenditure> jpaReader() throws Exception {
        ...
        parameters.put("environment", 1); // TRUE: 친환경
    ...
    public PagingQueryProvider createQueryProvider() throws Exception {
        ...
        queryProvider.setWhereClause("where user_email = :email and environment = :environment");
